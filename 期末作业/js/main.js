...
function aboutMe(){
    ...
    if(i==0){
        ...
        slogan2.innerHTML="这里是华成,这个废柴能熟练掌握面向百度编程、精通Word、Excel、PS等软件的安装于卸载;熟练掌握VB、C++、SQL、java等单词的拼写；熟悉Win7、Linux、Android、Ios等操作系统的开关机。";
    } else {
        i=0;
...
weixin.onmouseover=function(){
	weixin.src="img/wx.png";
	weixin.style.width="100px";
	
	
}
weixin.onmouseout=function(){
	weixin.src="img/微信.png";
	weixin.style.width="30px";
